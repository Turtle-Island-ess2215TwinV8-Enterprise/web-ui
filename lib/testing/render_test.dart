...
void renderTests(String baseDir, String inputDir, String expectedDir,
    String outDir, [List<String> args, String pattern, String script]) {
  ...
  for (var filePath in paths) {
    ...
    test('compile $filename', () {
      args.insertAll(args.length, ['-o', outDir, '--basedir', baseDir, filePath]);
      expect(dwc.run(args, printTime: false).then((res) {
